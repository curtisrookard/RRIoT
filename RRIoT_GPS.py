...
data = pd.read_csv('C:\\Users\\crookard\\Desktop\\TON-IoT\\Train_Test_IoT_GPS_Tracker.csv', sep=',')

# Keep Only Relevant Features
data = data[['ts', 'latitude', 'longitude','type']] 

# Creating Histogram 
data['type'].value_counts().plot(kind='bar', title='GPS Tracker Traffic Count')
...
class data_cls:
    def __init__(self,train_test,**kwargs):
        col_names = ['ts', 'latitude', 'longitude', 'type']
...
feature_names = ['ts', 'latitude', 'longitude']
